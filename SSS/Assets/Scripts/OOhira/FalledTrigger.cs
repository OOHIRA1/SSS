...
{
    [SerializeField]
    Effect _fallEffectPlayer = null;
    [SerializeField]
    Effect _fallEffectNpc = null;
    ...
    public GameObject GetFalledGameObject()
    {
        return _falledGameObject;
    }
    //======================================================
    //======================================================
    ...
    void Update()
    {
        ...
        {
            //アニメーションを終了したら消す処理------------------
            if (_fallEffectPlayer.ResearchStatePlayTime() >= 0.9f)
            { //1fにすると2ループ目エフェクトが表示されてしまうため0.9f
        ...
        {
            //アニメーションを終了したら消す処理------------------
            if (_fallEffectNpc.ResearchStatePlayTime() >= 0.9f)
            {    //1fにすると2ループ目エフェクトが表示されてしまうため0.9f
